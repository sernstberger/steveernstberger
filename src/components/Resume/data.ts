const jobs = [
  {
    ...
    startDate: "2019",
    description: [
      "As Lead Front-End Developer at Vemo Education, I lead our team of developers as we create software for students and administrators for income share agreements.",
      "I help create and architect technical requirements and their solutions, help and mentor other developers, and review code. I also have worked on implementing a design system across projects and also built algorithms that calculate loans and income share agreements.",
    ],
...

  {
    ...
    title: "Student",
    description: [
      "Bachelor’s of Arts Telecommunications, Multimedia focus",
      "Minor in Marketing",
    ],
  },
];

const resumeData = { jobs };
